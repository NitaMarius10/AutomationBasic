...
public class PracticeFormPage extends BasePage{
    ...
    public void chooseHobbies(){
        List<WebElement> hobbiesList = List.of(driver.findElement(sportHobbyElement), driver.findElement(readHobbyElement),
                driver.findElement(musicHobbyElement)); //am creat lista cu elementele dorite;
